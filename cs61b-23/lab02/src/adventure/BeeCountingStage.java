...
public class BeeCountingStage implements adventure.AdventureStage {
    private static final int[] SOME_NEAT_NUMBERS = {5, 3, 2, 6, 7};

    private final In in;
    private final Map<String, adventure.AdventureStage> responses;
    private List<String> input;

    public BeeCountingStage(In in) {
        this.in = in;
        this.responses = Map.of("go", new adventure.SpeciesListStage(in));
    }
